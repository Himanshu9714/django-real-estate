...
class Profile(DefaultMixinModel):
    ...
    country = CountryField(
        verbose_name=_("Country"), default="IN", blank=True, null=True
    )
    city = models.CharField(
        verbose_name=_("City"), max_length=180, blank=True, null=True, default="Mumbai"
    )
